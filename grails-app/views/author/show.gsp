...
<div id="show-author" class="content scaffold-show" role="main">
    ...
    <ol class="property-list author">
        ...
        <g:if test="${authorInstance?.dateOfBirth}">
            <li class="fieldcontain">
                <span id="dateOfBirth-label" class="property-label"><g:message code="author.dateOfBirth.label"
                                                                               default="Date Of Birth"/></span>

                <span class="property-value" aria-labelledby="dateOfBirth-label"><g:formatDate
                        date="${authorInstance?.dateOfBirth}"/></span>
        ...
        <g:if test="${authorInstance?.email}">
            <li class="fieldcontain">
                <span id="email-label" class="property-label"><g:message code="author.email.label"
                                                                         default="Email"/></span>

                <span class="property-value" aria-labelledby="email-label"><g:fieldValue bean="${authorInstance}"
                                                                                         field="email"/></span>
